...
Orientação a Serviços, surge como um novo paradigma de desenvolvimento de aplicações distribuídas que utiliza a figura de serviços como unidades que representam funcionalidades da aplicação antedendo as necessidades do negocio~\cite{erl2008soa}~\cite{cervantes2005technical}. 
...
Também define como os \textit{bundles} obtem acesso ao \textit{bundle context}. Responsável por controlar a interação dos \textit{bundles} com o framework.
