...
Devido às limitações de tempo e a percepção ainda não muito clara das melhores configurações de \verb Profiles ~e \verb Resources ~, realizamos uma comparação entre 2 políticas \textit{default} e a adaptativa (que varia entre as duas \textit{default} em função do contexto).
