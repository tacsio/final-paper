...
\item \textbf{Capítulo 2 - Orientação a Serviços}

Neste capítulo será apresentada uma intrudução à orientação a serviços. Seus principais conceitos TODO

\item \textbf{Capítulo 3 - OSGi}

Neste capítulo é introduzido os conceitos básicos do framework OSGi. Como sua arquitetura é organizada TODO

\item \textbf{Capítulo 4 - JMX}

O capítulo 4 apresenta a tecnologia JMX, que serve de base para a implementação do monitoramento de carga. Seus principais componentes e potencialidades.

\item \textbf{Capítulo 5 - Mecanismo Proposto}

No capítulo 5 será apresentado o mecanismo proposto, suas caracteríscas, seus objetivos e uma avaliação prática da solução para fins de validação.

\item \textbf{Capítulo 6 - Conclusão}

O capítulo 6 concluí o trabalho, apresentando as potencialidades e limitações da solução. E por fim, os possíveis trabalhos futuros abertos a desenvolvimento.
